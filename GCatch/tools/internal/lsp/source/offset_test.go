...
func TestTokenOffset(t *testing.T) {
	...
	}, "go/token", "github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/...", "github.com/system-pclub/GCatch/GCatch/tools/gopls/...")
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, pkg := range pkgs {
		for ident, obj := range pkg.TypesInfo.Uses {
			...
			// The only permitted use is in github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/source.Offset,
			...
			t.Errorf(`%s: Unexpected use of (*go/token.File).Offset. Please use github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/source.Offset instead.`, fset.Position(ident.Pos()))
		}
	}
}
