...
func TestContainingPackage(t *testing.T) {
	...
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/system-pclub/GCatch/GCatch/tools/go/buildutil", Files: packagestest.MustCopyFileTree(".")}})
	...
	tests := []Test{
		...
		{gopath, gopath + "/src/github.com/system-pclub/GCatch/GCatch/tools/go/buildutil/util_test.go",
			"github.com/system-pclub/GCatch/GCatch/tools/go/buildutil"},
	}
	...
	if runtime.GOOS != "windows" && runtime.GOOS != "plan9" {
		...
		tests = append(tests, []Test{
			{gopath, tmp + "/src/github.com/system-pclub/GCatch/GCatch/tools/go/buildutil/util_test.go", "github.com/system-pclub/GCatch/GCatch/tools/go/buildutil"},
			{tmp, gopath + "/src/github.com/system-pclub/GCatch/GCatch/tools/go/buildutil/util_test.go", "github.com/system-pclub/GCatch/GCatch/tools/go/buildutil"},
			{tmp, tmp + "/src/github.com/system-pclub/GCatch/GCatch/tools/go/buildutil/util_test.go", "github.com/system-pclub/GCatch/GCatch/tools/go/buildutil"},
		}...)
	}
